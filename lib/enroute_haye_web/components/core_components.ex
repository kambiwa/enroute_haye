defmodule EnrouteHayeWeb.CoreComponents do
  @moduledoc """
...
def status_label(other),       do: other || "—"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EnrouteHayeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EnrouteHayeWeb.Gettext, "errors", msg, opts)
    end
  end
