defmodule EnrouteHayeWeb.Auth.Review.Index do
   ...
   def render(assigns) do
    ~H"""
    <Layouts.admin_app flash={@flash} current_scope={@current_scope} current_page={:accommodations}>
        <%!-- <div class="container mx-auto px-4 py-8">
          ...
          <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="mb-4">
              <.link navigate={~p"/Reviews/new"} class="btn btn-primary">
                New Review
              </.link>
            </div>
